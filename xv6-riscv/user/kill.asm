...
00000000000003aa <gettraphistory>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 414:	4f080813          	addi	a6,a6,1264 # 900 <digits>
 418:	88be                	mv	a7,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 696:	26eb8b93          	addi	s7,s7,622 # 900 <digits>
 ...
 6e0:	21c48493          	addi	s1,s1,540 # 8f8 <malloc+0x10c>
        for(; *s; s++)
